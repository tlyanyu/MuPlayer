...
<template>
  <div class="user-agreement">
    ...
    <n-scrollbar class="scrollbar">
      ...
      <n-p>
        欢迎使用 MuPlayer（以下简称"本软件"）。本软件是一个本地音乐播放软件，可能会调用第三方 API
        来增强其功能。请在使用本软件前仔细阅读本用户协议。本协议是您（以下简称"用户"）与 MuPlayer
      ...
      <n-ol>
        ...
        <n-li>用户在使用、修改和分发 MuPlayer 时，必须遵守 AGPL-3.0 许可的条款和条件。</n-li>
        <n-li>
