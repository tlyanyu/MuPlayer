...
const routes: Array<RouteRecordRaw> = [
  ...
  // MV模块
  {
    path: "/mv",
    name: "mv",
    component: () => import("@/views/MV/layout.vue"),
    redirect: "/mv/recommend",
    children: [
      {
        path: "recommend",
        name: "mv-recommend",
        component: () => import("@/views/MV/recommend.vue"),
      },
      {
        path: "toplist",
        name: "mv-toplist",
        component: () => import("@/views/MV/toplist.vue"),
      },
      {
        path: "library",
        name: "mv-library",
        component: () => import("@/views/MV/library.vue"),
      },
    ],
  },
  // 我喜欢的音乐
